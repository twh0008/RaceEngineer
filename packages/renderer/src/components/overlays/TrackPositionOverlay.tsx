...
const TRACK_PATHS = {
  ...
  "monaco": "M 40,80 L 70,60 L 110,50 L 150,60 L 170,80 L 180,110 L 170,140 L 150,160 L 120,170 L 90,160 L 70,140 L 60,110 L 70,80 L 90,60 L 110,50 L 140,60 L 160,80 L 170,110 L 160,140 L 130,160 L 100,150 L 80,130 L 70,100 L 80,70 L 100,60 L 130,70 L 140,90 L 130,110 L 110,120 L 90,110 L 80,90 L 90,70",
  "silverstone": "M 40,70 L 80,50 L 130,40 L 180,50 L 210,80 L 230,120 L 220,160 L 190,190 L 150,200 L 100,190 L 60,160 L 40,120 L 50,80 L 80,60 L 120,60 L 150,80 L 160,110 L 150,140 L 120,160 L 80,150 L 60,120 L 70,90 L 90,70 L 120,70 L 140,90 L 140,120 L 120,140 L 90,140 L 70,120 L 70,90",
  "suzuka": "M 40,90 C 60,60 100,50 140,70 C 170,90 180,130 160,160 C 140,180 110,180 90,160 C 70,140 70,110 90,90 C 110,70 140,70 160,90 C 180,110 180,140 160,160 C 140,180 110,180 90,160 C 70,140 70,110 90,90"
};

// Track sectors for Spa (based on official F1 sector divisions)
const SPA_SECTORS = [
  { name: "Sector 1", path: "M 20,20 L 28,18 C 30,22 32,26 34,30 L 40,40 C 42,44 46,48 50,52", color: "#4CAF50" },
  { name: "Sector 2", path: "M 50,52 C 54,56 60,60 66,64 L 72,68 C 76,72 80,76 84,80 C 88,84 92,88 96,92 L 104,100", color: "#FFC107" },
  { name: "Sector 3", path: "M 104,100 C 108,104 112,108 116,112 L 120,116 C 116,120 112,124 108,128 C 104,132 100,136 96,140 L 92,144 C 88,148 84,152 80,156 L 72,164", color: "#F44336" }
];
...
export const TrackPositionOverlay: React.FC<TrackPositionProps> = ({ trackName = "spa" }) => {
  ...
  const trackPath = TRACK_PATHS[trackName as keyof typeof TRACK_PATHS] || TRACK_PATHS.spa;
  ...
  const getSpeedFactor = useCallback((progress: number) => {
    if (trackName === "spa") {
      ...
      if (progress > 0.10 && progress < 0.25) return 1.3; // Kemmel Straight
  ...
  const getCurrentSector = useCallback((progress: number) => {
    if (trackName === "spa") {
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      ...
      const calculatedSpeed = Math.floor(speedFactor * baseSpeed * speedConstant);
      ...
      <div className="track-position__overlay">
        ...
        <div className="track-position__svg-container">
          ...
          >
            ...
            {trackName === "spa" && SPA_SECTORS.map((sector, idx) => (
              <path
                key={`sector-${idx}`}
                d={sector.path}
            ...
            {trackName === "spa" && SPA_CORNERS.map((corner, idx) => (
              <g key={`corner-${idx}`}>
                <circle
                  cx={corner.x}
                  cy={corner.y}
